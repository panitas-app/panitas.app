        ...
        <Card className="rounded-2xl shadow-xs">
          <CardContent className="p-5">
            <div className="flex items-center justify-between mb-3">
              ...
              <div className="flex size-8 items-center justify-center rounded-xl bg-emerald-500/10 text-emerald-500"><TrendingUp className="size-4" /></div>
            </div>
        ...
        <Card className="rounded-2xl shadow-xs">
          <CardContent className="p-5">
            <div className="flex items-center justify-between mb-3">
              ...
              <div className="flex size-8 items-center justify-center rounded-xl bg-purple-500/10 text-purple-500"><Calendar className="size-4" /></div>
            </div>
        ...
        <Card className="rounded-2xl shadow-xs">
          <CardContent className="p-5">
            <div className="flex items-center justify-between mb-3">
              ...
              <div className="flex size-8 items-center justify-center rounded-xl bg-blue-500/10 text-blue-500"><Wallet className="size-4" /></div>
            </div>
        ...
        <Card className="rounded-2xl shadow-xs">
          <CardContent className="p-5">
            <div className="flex items-center justify-between mb-3">
              ...
              <div className="flex size-8 items-center justify-center rounded-xl bg-rose-500/10 text-rose-500"><Users className="size-4" /></div>
            </div>
      ...
      <div className="grid gap-6 lg:grid-cols-3">
        ...
        <Card className="rounded-2xl">
          ...
          <CardContent className="space-y-2">
            <Link href="/dashboard/employees" className="flex items-center gap-3 rounded-xl p-3 hover:bg-muted transition-colors group">
            ...
            <Link href="/dashboard/finanzas" className="flex items-center gap-3 rounded-xl p-3 hover:bg-muted transition-colors group">
              <div className="flex size-9 items-center justify-center rounded-xl bg-emerald-500/10 text-emerald-500"><DollarSign className="size-4" /></div>
            ...
            <Link href="/dashboard/analytics" className="flex items-center gap-3 rounded-xl p-3 hover:bg-muted transition-colors group">
              <div className="flex size-9 items-center justify-center rounded-xl bg-amber-500/10 text-amber-500"><BarChart3 className="size-4" /></div>
              ...
              {recentActivity.map((a) => (
                <div key={a.id} className="flex items-center gap-3 py-3">
                  <div className={`flex size-8 items-center justify-center rounded-full ${
                    a.type === "sale" ? "bg-emerald-500/10 text-emerald-400" :
                    a.type === "appointment" ? "bg-purple-500/10 text-purple-400" :
                    a.type === "client" ? "bg-blue-500/10 text-blue-400" :
                    a.type === "cancel" ? "bg-red-500/10 text-red-400" :
                    a.type === "payment" ? "bg-green-500/10 text-green-400" :
