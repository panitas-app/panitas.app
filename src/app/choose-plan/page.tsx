...
function VideoCycler({ videos, isActive }: { videos: string[]; isActive: boolean }) {
...
export default function ChoosePlanPage() {
  ...
  return (
    <div className="min-h-screen bg-[#071A33] relative overflow-hidden">
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-4 h-screen flex flex-col overflow-hidden">
        ...
        <AnimatePresence mode="wait">
          {expandedId && expandedPlan ? (
            ...
            >
              ...
              >
                <div className="absolute inset-0">
                  <VideoCycler videos={expandedPlan.videos} isActive={true} />
                ...
                <div className="relative p-8 sm:p-12 lg:p-16">
                  <button
                    ...
                    className="inline-flex items-center gap-2 text-sm font-medium text-white/40 hover:text-white transition-colors mb-8 group"
                  >
                    <svg
                  ...
                  <div className="grid lg:grid-cols-2 gap-10 lg:gap-16 items-start">
                    <div>
                      ...
                      <p className="mt-2 text-lg text-white/50">{expandedPlan.tagline}</p>
                      <div className="mt-6 space-y-2">
                        <div className="flex items-baseline gap-2">
                          <span className="text-5xl sm:text-6xl font-bold" style={{ color: expandedPlan.accent }}>
                            ${expandedPlan.price}
                          </span>
                          <span className="text-lg text-white/40 font-medium">/mes · pago único</span>
                        </div>
                        <div className="flex items-baseline gap-2">
                          <span className="text-2xl sm:text-3xl font-bold text-white/60">
                            ${expandedPlan.installmentAmount}
                          </span>
                          <span className="text-sm text-white/40 font-medium">/cuota · 2 cuotas (${expandedPlan.installmentAmount * 2} total)</span>
                        </div>
                      </div>
                      <p className="mt-6 text-white/60 leading-relaxed">{expandedPlan.description}</p>
                    </div>

                    <div>
                      <h3 className="text-lg font-semibold text-white mb-5">Beneficios incluidos</h3>
                      ...
                      >
                        <Link
                          ...
                          className="group relative inline-flex items-center justify-center gap-2.5 px-8 py-4 bg-gradient-to-br from-[#0066FF] to-[#0044CC] text-white font-semibold text-base rounded-lg overflow-hidden transition-all duration-300 hover:shadow-[0_0_30px_rgba(0,102,255,0.35)] hover:scale-[1.02] active:scale-[0.98]"
                        >
                        ...
                        <div className="flex flex-col sm:flex-row items-center gap-3">
                          <Link
                            ...
                            className="group relative inline-flex items-center justify-center gap-2 px-6 py-3 border border-white/15 text-white font-medium text-sm rounded-lg overflow-hidden transition-all duration-200 hover:border-white/30 hover:bg-white/5"
                          >
                          ...
                          <Link
                            ...
                            className="inline-flex items-center justify-center gap-2 px-4 py-2 text-xs font-medium text-white/30 border border-white/5 rounded-lg hover:border-white/15 hover:text-white/50 transition-all duration-200 group"
                          >
            ...
            <motion.div
              ...
              className="flex-1 flex items-center justify-center"
            >
              <div className="flex flex-col md:flex-row gap-5 lg:gap-6 w-full max-w-5xl justify-center items-start">
                {plans.map((plan, i) => {
                    ...
                    >
                      ...
                      >
                        <div className="absolute inset-0 overflow-hidden">
                          ...
                          >
                            <VideoCycler videos={plan.videos} isActive={true} />
                          </motion.div>
                        ...
                        <div className="relative p-5 sm:p-7 flex flex-col h-full">
                          ...
                          <motion.h3
                            className="mt-2 text-xl sm:text-2xl font-heading font-bold text-white"
                            layout
                          ...
                          >
                              <div className="pt-3 space-y-2">
                                <div className="flex items-baseline gap-1.5">
                                  <span className="text-3xl sm:text-4xl font-bold" style={{ color: plan.accent }}>
                                    ${plan.price}
                                  </span>
                                ...
                                <div className="flex items-baseline gap-1.5">
                                  ...
                                  <span className="text-xs text-white/30">/cuota · 2 cuotas</span>
                                </div>
                              <p className="text-sm text-white/60 leading-relaxed">{plan.description}</p>
                              <ul className="space-y-1.5 pt-1">
                                {plan.benefits.slice(0, 3).map((b, bi) => (
                                  <li key={bi} className="flex items-start gap-2 text-xs text-white/50">
                                    <svg
