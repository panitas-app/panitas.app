  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-blue-50 to-yellow-50 px-4">
      <div className="text-center space-y-6 max-w-md">
        ...
        <h1 className="font-heading text-3xl font-bold text-[#102A43]">Tienda no encontrada</h1>
        <p className="text-muted-foreground">
          La tienda que buscas no existe, fue desactivada o el enlace es incorrecto.
        </p>
