...
const SECTIONS = [
  {
    nombre: "Apertura", descripcion: "Romper el hielo — no empezar vendiendo", icono: "MessageCircle", orden: 0, route: "emprendedor_presencial", tipo: "info",
  ...
  },
  {
    ...
    questions: [
      { texto: "Como registran actualmente sus ventas?", tipo: "radio", opciones: '["Sistema POS","Excel","Cuaderno","Calculadora","No registran"]', orden: 0, puntaje: '{"No registran":20,"Cuaderno":15,"Calculadora":15,"Excel":10,"Sistema POS":0}' },
      { texto: "Como controlan actualmente el inventario?", tipo: "radio", opciones: '["Sistema","Excel","Cuaderno","Memoria","No llevan control"]', orden: 1, puntaje: '{"No llevan control":20,"Memoria":18,"Cuaderno":15,"Excel":10,"Sistema":0}' },
      { texto: "Cuantos productos manejan aproximadamente?", tipo: "radio", opciones: '["Menos de 50","50 - 200","200 - 500","Mas de 500"]', orden: 2, puntaje: '{"Mas de 500":15,"200 - 500":12,"50 - 200":8,"Menos de 50":0}' },
      { texto: "Cuantas personas participan en las ventas?", tipo: "radio", opciones: '["Solo el dueno","1 empleado","2-5 empleados","Mas de 5 empleados"]', orden: 3, puntaje: '{"Mas de 5 empleados":15,"2-5 empleados":12,"1 empleado":5,"Solo el dueno":0}' },
      { texto: "Cuando un cliente pregunta por un producto, pueden saber inmediatamente si tienen disponibilidad?", tipo: "radio", opciones: '["Siempre","Algunas veces","No"]', orden: 4, puntaje: '{"No":15,"Algunas veces":8,"Siempre":0}' },
      { texto: "Cuando termina el dia, saben exactamente cuanto vendieron?", tipo: "radio", opciones: '["Si","No"]', orden: 5, puntaje: '{"No":15,"Si":0}' },
      { texto: "Pueden saber cuales productos generan mas ventas?", tipo: "radio", opciones: '["Si","No"]', orden: 6, puntaje: '{"No":10,"Si":0}' },
    ],
  },
  {
    nombre: "Descubrir el Dolor", descripcion: "Identificar problemas y necesidades", icono: "AlertTriangle", orden: 2, route: "emprendedor_presencial", tipo: "questions",
    questions: [
      { texto: "Han tenido alguno de estos problemas?", tipo: "checklist", opciones: '["Perder ventas por no saber si habia inventario","Diferencias entre inventario real y registrado","No saber cuanto se vende diariamente","Errores al registrar ventas","Problemas con empleados","Mucho tiempo haciendo cuentas manuales","No saber cuales productos son mas rentables","Otro"]', orden: 0, requerida: false, puntaje: '{"Perder ventas por no saber si habia inventario":15,"Diferencias entre inventario real y registrado":12,"No saber cuanto se vende diariamente":12,"Errores al registrar ventas":10,"Problemas con empleados":8,"Mucho tiempo haciendo cuentas manuales":10,"No saber cuales productos son mas rentables":8,"Otro":5}' },
    ],
  },
  {
    nombre: "Presentacion de Panitas", descripcion: "Beneficios segun las respuestas del diagnostico", icono: "Star", orden: 3, route: "emprendedor_presencial", tipo: "info",
  ...
  {
    nombre: "Cierre", descripcion: "Evaluar interes y definir proxima accion", icono: "Target", orden: 4, route: "emprendedor_presencial", tipo: "questions",
    questions: [
      { texto: "Si pudieras saber exactamente que vendes, cuanto tienes disponible y como funciona tu negocio desde tu telefono, crees que esto resolveria un problema importante?", tipo: "radio", opciones: '["Si","No","Necesito pensarlo"]', orden: 0, puntaje: '{"Si":20,"Necesito pensarlo":5,"No":0}' },
    ],
  },
  {
    nombre: "Objeciones", descripcion: "Manejo de objeciones del prospecto", icono: "ShieldAlert", orden: 5, route: "emprendedor_presencial", tipo: "info",
  ...
  {
    nombre: "Apertura", descripcion: "Apertura para negocios que venden por redes", icono: "MessageCircle", orden: 0, route: "emprendedor_online", tipo: "info",
  ...
  },
  {
    ...
    questions: [
      { texto: "Actualmente venden por internet o redes sociales?", tipo: "radio", opciones: '["Instagram","WhatsApp","Pagina web","No venden online"]', orden: 0, puntaje: '{"No venden online":15,"WhatsApp":8,"Instagram":5,"Pagina web":0}' },
      { texto: "Cuando un cliente pregunta por un producto, como le muestran lo que tienen disponible?", tipo: "radio", opciones: '["Fotos enviadas manualmente","Catalogo","Pagina web","No tienen catalogo"]', orden: 1, puntaje: '{"No tienen catalogo":20,"Fotos enviadas manualmente":15,"Catalogo":5,"Pagina web":0}' },
      { texto: "Tienen un inventario actualizado conectado con sus ventas?", tipo: "radio", opciones: '["Si","No"]', orden: 2, puntaje: '{"No":15,"Si":0}' },
      { texto: "Cuanto tiempo pasan respondiendo preguntas de productos y precios?", tipo: "radio", opciones: '["Poco","Varias horas al dia","Mucho tiempo"]', orden: 3, puntaje: '{"Mucho tiempo":15,"Varias horas al dia":10,"Poco":0}' },
      { texto: "Alguna vez un cliente quiso comprar algo y ya no tenian disponibilidad?", tipo: "radio", opciones: '["Si","No"]', orden: 4, puntaje: '{"Si":15,"No":0}' },
    ],
  },
  {
    nombre: "Descubrir el Dolor", descripcion: "Identificar problemas con ventas online", icono: "AlertTriangle", orden: 2, route: "emprendedor_online", tipo: "questions",
    questions: [
      { texto: "Cuales de estos problemas han tenido?", tipo: "checklist", opciones: '["Muchas preguntas repetidas por WhatsApp","No tienen catalogo organizado","Pierden ventas fuera del horario","No saben que productos tienen disponibles","Publican productos que ya no tienen","Les cuesta mostrar todos sus productos"]', orden: 0, requerida: false, puntaje: '{"Muchas preguntas repetidas por WhatsApp":12,"No tienen catalogo organizado":15,"Pierden ventas fuera del horario":15,"No saben que productos tienen disponibles":12,"Publican productos que ya no tienen":15,"Les cuesta mostrar todos sus productos":10}' },
    ],
  },
  {
    nombre: "Presentacion de Panitas", descripcion: "Beneficios segun las respuestas del diagnostico digital", icono: "Star", orden: 3, route: "emprendedor_online", tipo: "info",
  ...
  {
    nombre: "Cierre", descripcion: "Evaluar interes y definir proxima accion", icono: "Target", orden: 4, route: "emprendedor_online", tipo: "questions",
    questions: [
      { texto: "Si tus clientes pudieran ver tus productos disponibles y comprar sin tener que preguntarte todo por WhatsApp, crees que ayudaria a vender mas?", tipo: "radio", opciones: '["Si","No","Quiero verlo"]', orden: 0, puntaje: '{"Si":20,"Quiero verlo":10,"No":0}' },
    ],
  },
  {
    nombre: "Objeciones", descripcion: "Manejo de objeciones del prospecto online", icono: "ShieldAlert", orden: 5, route: "emprendedor_online", tipo: "info",
  ...
  },
  {
    ...
    questions: [
      { texto: "Como agenda actualmente sus consultas?", tipo: "radio", opciones: '["Agenda fisica","WhatsApp","Llamadas telefonicas","Excel","Sistema especializado","Otro"]', orden: 0, puntaje: '{"Agenda fisica":15,"WhatsApp":12,"Llamadas telefonicas":12,"Excel":8,"Sistema especializado":0,"Otro":10}' },
      { texto: "Quien administra actualmente las citas?", tipo: "radio", opciones: '["Yo personalmente","Secretaria","Asistente","Varias personas"]', orden: 1, puntaje: '{"Yo personalmente":15,"Secretaria":8,"Asistente":8,"Varias personas":0}' },
      { texto: "Cuantas consultas realiza aproximadamente por semana?", tipo: "radio", opciones: '["Menos de 10","10-30","30-50","Mas de 50"]', orden: 2, puntaje: '{"Mas de 50":15,"30-50":12,"10-30":8,"Menos de 10":0}' },
      { texto: "Cuando un paciente quiere una cita, que debe hacer?", tipo: "radio", opciones: '["Escribir por WhatsApp","Llamar","Esperar respuesta","Reservar online"]', orden: 3, puntaje: '{"Esperar respuesta":15,"Escribir por WhatsApp":12,"Llamar":10,"Reservar online":0}' },
      { texto: "Cuales problemas ha tenido con su agenda?", tipo: "checklist", opciones: '["Pacientes olvidan citas","Cruce de horarios","Mucho tiempo respondiendo mensajes","Dificultad organizando disponibilidad","No tiene historial organizado","Ninguno"]', orden: 4, requerida: false, puntaje: '{"Pacientes olvidan citas":12,"Cruce de horarios":15,"Mucho tiempo respondiendo mensajes":15,"Dificultad organizando disponibilidad":12,"No tiene historial organizado":10,"Ninguno":0}' },
    ],
  },
  {
    ...
    questions: [
      { texto: "Cuanto tiempo dedica al dia coordinando citas?", tipo: "radio", opciones: '["Menos de 15 minutos","15-30 minutos","Mas de 30 minutos","Mas de una hora"]', orden: 0, puntaje: '{"Mas de una hora":20,"Mas de 30 minutos":15,"15-30 minutos":8,"Menos de 15 minutos":0}' },
      { texto: "Puede saber facilmente cuantas consultas realizo este mes?", tipo: "radio", opciones: '["Si","No"]', orden: 1, puntaje: '{"No":15,"Si":0}' },
      { texto: "Tiene informacion organizada de sus pacientes?", tipo: "radio", opciones: '["Si","No"]', orden: 2, puntaje: '{"No":15,"Si":0}' },
    ],
  },
  {
  ...
  },
  {
    ...
    questions: [
      { texto: "Que tipo de negocio tienes?", tipo: "radio", opciones: '["Barberia","Salon de belleza","Spa","Uñas","Pestañas","Masajes","Estetica","Otro"]', orden: 0, puntaje: '{}' },
      { texto: "Como reservan actualmente tus clientes?", tipo: "radio", opciones: '["WhatsApp","Instagram","Llamadas","Llegan directamente","Agenda fisica"]', orden: 1, puntaje: '{"WhatsApp":12,"Instagram":10,"Llamadas":10,"Llegan directamente":15,"Agenda fisica":12}' },
      { texto: "Cuantas personas atienden clientes?", tipo: "radio", opciones: '["Solo yo","2 personas","3-5 personas","Mas de 5"]', orden: 2, puntaje: '{"Solo yo":5,"2 personas":8,"3-5 personas":12,"Mas de 5":15}' },
      { texto: "Tienen horarios disponibles que quedan sin clientes?", tipo: "radio", opciones: '["Nunca","Algunas veces","Frecuentemente"]', orden: 3, puntaje: '{"Frecuentemente":15,"Algunas veces":10,"Nunca":0}' },
      { texto: "Han perdido clientes por tardar en responder mensajes?", tipo: "radio", opciones: '["Si","No"]', orden: 4, puntaje: '{"Si":20,"No":0}' },
    ],
  },
  {
  ...
  },
  {
    ...
    questions: [
      { texto: "Actualmente tus clientes deben preguntarte disponibilidad antes de reservar?", tipo: "radio", opciones: '["Si siempre","Algunas veces","No"]', orden: 0, puntaje: '{"Si siempre":15,"Algunas veces":8,"No":0}' },
      { texto: "Tus clientes usan WhatsApp o redes sociales frecuentemente?", tipo: "radio", opciones: '["Mucho","Regular","Poco"]', orden: 1, puntaje: '{"Mucho":10,"Regular":5,"Poco":0}' },
      { texto: "Te gustaria que tus clientes pudieran reservar directamente desde tu WhatsApp?", tipo: "radio", opciones: '["Si","No","Quiero verlo"]', orden: 2, puntaje: '{"Si":15,"Quiero verlo":10,"No":0}' },
    ],
  },
  {
...
export async function POST(req: NextRequest) {
  try {
    ...
    const existingSections = await prisma.salesSection.count()
    const existingScoringRules = await prisma.salesScoringRule.count()
    const existingPlanRules = await prisma.salesPlanRecommendation.count()

    if (existingSections > 0 || existingScoringRules > 0 || existingPlanRules > 0) {
      return NextResponse.json({
        error: "Ya existen datos de guion de venta en la base de datos",
        sections: existingSections,
        scoringRules: existingScoringRules,
        planRules: existingPlanRules,
      }, { status: 409 })
    }
    ...
    for (const section of SECTIONS) {
      ...
      for (const q of section.questions) {
        ...
        const qq: { texto: string; tipo: string; opciones?: string; orden: number; requerida?: boolean; puntaje?: string; placeholder?: string; subtexto?: string; condicionLogica?: string } = q
        await prisma.$executeRawUnsafe(
          `INSERT INTO "SalesQuestion" (id, texto, tipo, opciones, orden, requerida, puntaje, placeholder, subtexto, "condicionLogica", metadata, "sectionId", activo, "createdAt", "updatedAt")
           VALUES ($1, $2, $3, $4, $5::int, $6, $7, $8, $9, $10, $11, $12, true, NOW(), NOW())`,
          questionId, qq.texto, qq.tipo, qq.opciones || null, qq.orden, qq.requerida !== false, qq.puntaje || null, qq.placeholder || null, qq.subtexto || null, qq.condicionLogica || null, null, sectionId
        )
        questionsCreated++
      }
    }
    ...
    return NextResponse.json({
      ...
      scoringRules: scoringRulesCreated,
      planRules: planRulesCreated,
    })
  } catch (error) {
