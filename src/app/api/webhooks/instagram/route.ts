/**
 * Instagram (FASE 8B) — Webhook de Meta.
 *
 * `GET`  — handshake de suscripción de Instagram webhooks.
...
export async function GET(request: NextRequest) {
  return metaWebhookGet(request, "instagram")
}

export async function POST(request: NextRequest) {
  return metaWebhookPost(request, "instagram")
}
